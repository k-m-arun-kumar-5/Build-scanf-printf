...
uint16_t Disable_Interrupt_Src(const uint8_t disable_interrupt_request_src)
{
	...
	switch(cur_intp_req_ctrl_ptr->interrupt_type)
	{
        ...
        default:
              system_status_flag = ERR_FORMAT_INVALID;
		      Error_or_Warning_Proc("13.03.03", ERROR_OCCURED, system_status_flag);
		      return system_status_flag;		  
	}
   ...
   uint8_t ext_interrupt_func_mode, ext_interrupt_req_src_id;
    ...
    switch(ext_interrupt_ch_id)
    {
        case CH_ID_00:
	       switch(cur_ext_intp_ctrl_ptr->ext_interrupt_func_mode)
		   {
			   case IO_FUNC_MODE_01:
			       cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_16;
			   break;
			   case IO_FUNC_MODE_03:
                   cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_01; 
               break;
               default:
        ...
        case CH_ID_01:
		   switch(cur_ext_intp_ctrl_ptr->ext_interrupt_func_mode)
		   {
			   case IO_FUNC_MODE_02:
			      cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_14; 
			   break;
			   case IO_FUNC_MODE_03:
                   cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_03; 
               break;
               default:
                  system_status_flag = ERR_NON_GPIO_FUNC_SET;
        ...
        case CH_ID_02:
		   ...
		   {
			   case IO_FUNC_MODE_02:
			      cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_15; 
			   break;
			   case IO_FUNC_MODE_03:
                   cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_07; 
               break;
               default:
                  system_status_flag = ERR_NON_GPIO_FUNC_SET;
        ...
        case CH_ID_03:
		   ...
		   {
			   case IO_FUNC_MODE_01:
			      cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_20; 
			   break;	  
			   case IO_FUNC_MODE_02:
			       cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_30; 
			   break;
			   case IO_FUNC_MODE_03:
                   cur_ext_intp_status_ptr->ext_interrupt_io_ch = IO_CH_09; 
               break;
               default:
                  system_status_flag = ERR_NON_GPIO_FUNC_SET;
	              Error_or_Warning_Proc("13.12.07", ERROR_OCCURED, system_status_flag);
		          return system_status_flag;    			   
		   }	      
        break;                    		
    }
	...
	if((Non_GPIO_Func_Set(cur_ext_intp_status_ptr->ext_interrupt_io_ch, ext_interrupt_func_mode )) != SUCCESS)
	{
	     ...
	     Error_or_Warning_Proc("13.12.08", ERROR_OCCURED, system_status_flag);
		 return system_status_flag;
	}
	...
	if((Enable_Interrupt_Src(ext_interrupt_req_src_id)) != SUCCESS)
	{
		 ...
		 Error_or_Warning_Proc("13.12.09", ERROR_OCCURED, system_status_flag);
		 return system_status_flag;
	}      	
    return SUCCESS;  
}
